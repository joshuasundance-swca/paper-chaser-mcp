...
TOOL_DESCRIPTIONS = {
    ...
    "search_papers_bulk": (
        ...
        "IMPORTANT: This tool always uses Semantic Scholar, regardless of which "
        "provider search_papers used. If your previous search_papers call returned "
        "results from CORE, arXiv, or SerpApi (brokerMetadata.providerUsed is not "
        "'semantic_scholar', or brokerMetadata.bulkSearchIsProviderPivot is true), "
        "calling this tool is a provider pivot to Semantic Scholar — not a "
        "continuation from the original provider. "
