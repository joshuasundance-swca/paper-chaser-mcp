...
def _package_version() -> str:
    try:
        return version("scholar-search-mcp")
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="scholar-search-mcp",
        description=(
            "Run the Scholar Search MCP server. The default command starts the "
            "package-local MCP server using SCHOLAR_SEARCH_* environment "
