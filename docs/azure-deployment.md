...
5. Populate Key Vault with these secret names before production deployment:
  ...
  - `huggingface-api-key` if you enable the smart layer with `agenticProvider=huggingface`
