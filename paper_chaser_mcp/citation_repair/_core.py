...
# Re-export ranking helpers so existing callers in this module and the
# `citation_repair` facade can continue to reach them by their legacy names.
# Imported at the bottom to avoid a circular import cycle with `.ranking`.
from .ranking import (  # noqa: E402, F401  (intentional late re-export to break cycle)
    RankedCitationCandidate,
