"""LangChain-based chat provider bundle (``LangChainChatProviderBundle``).

Extracted from ``paper_chaser_mcp.agentic.provider_langchain`` during
Phase 8d of the modularization refactor. The shim at
``paper_chaser_mcp.agentic.provider_langchain`` re-exports the public
