"""Phase 7c-1: async planner orchestration and evidence-grounded expansion.

Extracted from :mod:`paper_chaser_mcp.agentic.planner._core` without behavioural
changes. Holds ``classify_query`` (planner invocation + deterministic
reconciliation) and the provider-driven grounded/speculative expansion helpers.
"""
...
from .specificity import _looks_broad_concept_query
